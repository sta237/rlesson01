...
## Simulating the Monty Hall Dillema

Can you simulate the Monty Hall problem? Assume the participant always select the first door initially then switch to the other available after Monty (the host) reveals a goat. 

```{r montyhall, exercise=TRUE, exercise.lines=50}
